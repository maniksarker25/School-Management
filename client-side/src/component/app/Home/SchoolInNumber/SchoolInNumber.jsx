...
const SchoolInNumber = () => {
    return (
        <Parallax className='my-10' blur={0} strength={-200} bgImage='https://images.pexels.com/photos/3170082/pexels-photo-3170082.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' >
